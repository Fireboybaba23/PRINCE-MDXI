...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~GUoUu5cpLDRJsxHgw78U", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2348139598985", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "HIM", // Input Yours custom...(Maintain font for Flow)
